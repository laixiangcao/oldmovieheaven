package com.jiumeng.movieheaven.views.itemdrag;
 ...
 */
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener ,OnCompleteEditListener{
    // 我的频道 标题部分
    ...
    private ArrayList<ViewPageInfo> mMyChannelItems, mOtherChannelItems;
    ...
    public ChannelAdapter(Context context, ItemTouchHelper helper, ArrayList<ViewPageInfo> mMyChannelItems, ArrayList<ViewPageInfo> mOtherChannelItems) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            myHolder.textView.setText(mMyChannelItems.get(position - COUNT_PRE_MY_HEADER).getTitle());
            if (isEditMode) {
            ...
            ((OtherViewHolder) holder).textView.setText(mOtherChannelItems.get(position - mMyChannelItems.size() - COUNT_PRE_OTHER_HEADER).getTitle());
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        ViewPageInfo item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        ViewPageInfo item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        ViewPageInfo item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
    ...
    private void cancelEditMode(RecyclerView parent) {
        ...
        //完成编辑回调
        ArrayList<ArrayList<ViewPageInfo>> data = new ArrayList<>();
        data.add(mMyChannelItems);
        data.add(mOtherChannelItems);
        completeEdit(data);
    }
    ...
    public void setOnCompleteEditListener(OnCompleteEditListener listener){
        this.OnCompleteEditListener=listener;
    }

    @Override
    public void completeEdit(ArrayList<ArrayList<ViewPageInfo>> channelData) {
        if (OnCompleteEditListener!=null){
            OnCompleteEditListener.completeEdit(channelData);
        }
    }
